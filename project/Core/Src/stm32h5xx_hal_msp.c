...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    PF7     ------> SPI5_SCK
    */
    GPIO_InitStruct.Pin = STMOD_03_Pin|STMOD_02_Pin|STMOD_04_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI2)
  {
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOI, ARD_D13_Pin|ARD_D12_Pin);
  ...
  else if(hspi->Instance==SPI5)
  {
    ...
    PF7     ------> SPI5_SCK
    */
    HAL_GPIO_DeInit(GPIOF, STMOD_03_Pin|STMOD_02_Pin|STMOD_04_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PA9     ------> USART1_TX
    */
    GPIO_InitStruct.Pin = VCP_T_RX_Pin|VCP_T_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PA9     ------> USART1_TX
    */
    HAL_GPIO_DeInit(GPIOA, VCP_T_RX_Pin|VCP_T_TX_Pin);

...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(ARD_D02_GPIO_Port, ARD_D02_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOI, LED_GREEN_Pin|LED_ORANGE_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, LED_RED_Pin|LED_BLUE_Pin|STMOD_01_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ARD_D10_GPIO_Port, ARD_D10_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(STMOD_08_GPIO_Port, STMOD_08_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, ARD_D06_Pin|ARD_D05_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_RED_Pin LED_BLUE_Pin STMOD_01_Pin */
  GPIO_InitStruct.Pin = LED_RED_Pin|LED_BLUE_Pin|STMOD_01_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  ...
  /*Configure GPIO pins : ARD_D08_Pin ARD_D07_Pin ARD_D04_Pin */
  GPIO_InitStruct.Pin = ARD_D08_Pin|ARD_D07_Pin|ARD_D04_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : STMOD_08_Pin ARD_D06_Pin ARD_D05_Pin */
  GPIO_InitStruct.Pin = STMOD_08_Pin|ARD_D06_Pin|ARD_D05_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOH, &GPIO_InitStruct);

  /*Configure GPIO pin : STMOD_19_Pin */
  GPIO_InitStruct.Pin = STMOD_19_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(STMOD_19_GPIO_Port, &GPIO_InitStruct);
